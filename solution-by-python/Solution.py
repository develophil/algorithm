...
class Solution:
    ...
    def maxSubArray(self, nums: List[int]) -> int:
        ...
        maxSum = prevSum = nums[0]

        for i in range(1, len(nums)):
            current = nums[i]
            prevSum = max(prevSum + current, current)
